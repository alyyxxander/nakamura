...
insert into menu_items( category, title, id, description, price ) 
...
insert into menu_items( category, title, id, description, price )  
    values( "CATEGORY", "Hokki", "hokki", "surf clam", 1.00 ); 

insert into menu_items( category, title, id, description, price )  
    values( "CATEGORY", "Geso", "geso", "cooked squid", 1.00 ); 

insert into menu_items( category, title, id, description, price )  
    values( "CATEGORY", "Ebi", "ebi", "butterflied shrimp", 1.00 ); 
